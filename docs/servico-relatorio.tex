...
\begin{titlepage}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \textbf{Autor:} Leandro S. Barbosa\\
    \textbf{Contato:} leandro.silveirabarbosa@gmail.com
  \end{minipage}
  \vfill
...
\begin{tabular}{ll}
\toprule
\textbf{Categoria de Ataque} & \textbf{Exemplo} \\
\midrule
...
Pseudonimização & SHA-256 (16 hex) & IDs de usuário, canal e servidor hashados \\
HTTP method check & Apenas GET & Health server retorna 405 para outros métodos \\
Security headers & 5 headers & X-Content-Type-Options, X-Frame-Options, etc. \\
Escape de RegExp & \texttt{escapeRegExp()} & Previne ReDoS em interpolação de variáveis \\
\bottomrule
\end{longtable}
...
Uma análise completa de segurança foi realizada em 31/07/2026 utilizando ferramentas de Análise Estática (SAST) e Testes Dinâmicos (DAST).
...
\begin{longtable}{lll}
\toprule
\textbf{Issue} & \textbf{Severidade} & \textbf{Status} \\
\midrule
\endhead
ReDoS (CWE-1333) & MEDIUM & ✅ CORRIGIDO \\
HTTP Method Tampering & LOW & ✅ CORRIGIDO \\
Security Headers Ausentes & MEDIUM & ✅ CORRIGIDO \\
Senha Hardcoded PostgreSQL & MEDIUM & ✅ CORRIGIDO \\
\bottomrule
\end{longtable}
...
\vspace{1cm}
\begin{flushright}
\textbf{Leandro S. Barbosa}\\
Aluno da Pós-Graduação em Engenharia de Software com IA Aplicada\\
UNIPDS / Anhanguera\\
leandro.silveirabarbosa@gmail.com\\
Julho de 2026
\end{flushright}
