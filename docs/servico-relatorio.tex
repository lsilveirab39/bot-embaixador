...
\toprule
\rowcolor{tableheader}
\color{tableheadertext}\textbf{Controle} & \color{tableheadertext}\textbf{Configuração} & \color{tableheadertext}\textbf{Descrição} \\
\midrule
\endhead
\rowcolor{tableroweven}
...
Trigger por reply & Configurável & Responde apenas a menções ou replies \\
\rowcolor{tableroweven}
...
\end{quote}
Inicia um jogo com 10 perguntas sobre Prompt Engineering. Jogadores entram reagindo com 🎮 e respondem clicando nos botões coloridos.
...
\toprule
\rowcolor{tableheader}
\color{tableheadertext}\textbf{Cargo} & \color{tableheadertext}\textbf{Critério} \\
\midrule
\rowcolor{tableroweven}
